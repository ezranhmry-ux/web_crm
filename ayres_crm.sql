...
INSERT INTO `orders` (`id`, `no_order`, `customer_id`, `customer_nama`, `customer_phone`, `customer_alamat`, `customer_desa`, `customer_kecamatan`, `customer_kabupaten`, `customer_provinsi`, `lead_id`, `nama_tim`, `tanggal_order`, `estimasi_deadline`, `keterangan`, `status`, `nominal_order`, `dp_desain`, `dp_produksi`, `kekurangan`, `tanggal_acc_proofing`, `ekspedisi`, `tracking_link`, `created_at`, `updated_at`) VALUES
(1, 'ORD001', NULL, 'EZRA K NAHUMURY', '082338142821', 'TALAGA RAJA', 'KEL BATU GAJA', 'SIRIMAU', 'KOTA AMBON', 'MALUKU', 1, 'EZ CSv', '2026-04-01', '2026-04-09', 'FREE LOGO 3D 1', 'IN_PROGRESS', 150000.00, 20000.00, 50000.00, 80000.00, NULL, NULL, '/tracking/WO0401-001', '2026-04-01 07:25:15', '2026-04-01 09:16:36'),
(5, 'ORD002', NULL, 'ZEXO', '085335334466', 'JL. BUNTU', 'GALALA', 'SIRIMAU', 'KOTA AMBON', 'MALUKU', 1, 'XEOOO', '2026-04-02', '2026-04-12', 'S', 'IN_PROGRESS', 200000.00, 50000.00, 50000.00, 100000.00, NULL, NULL, '/tracking/WO0402-001', '2026-04-02 06:39:56', '2026-04-02 06:56:05'),
(6, 'ORD003', NULL, 'LEIF', '0898765432', 'JL. SOLO', 'LUMUT MAJU', 'LUMUT', 'KABUPATEN TAPANULI TENGAH', 'SUMATERA UTARA', 1, 'LEIF FC', '2026-04-08', '2026-04-15', '-', 'IN_PROGRESS', 500000.00, 150000.00, 0.00, 350000.00, '2026-04-14', 'JNE', '/tracking/WO0408-001', '2026-04-08 06:44:33', '2026-04-08 06:52:35');

-- --------------------------------------------------------

--
-- Table structure for table `order_detail_bahan`
--
...
--
-- Dumping data for table `order_detail_bahan`
--

INSERT INTO `order_detail_bahan` (`id`, `order_id`, `bagian`, `bahan`) VALUES
(1, 6, 'FRONT BODY', 'AUTHENTIC WOVEN'),
(2, 6, 'BACK BODY', 'BENZEMA'),
(3, 6, 'SLEEVE', 'AIRWALK'),
(4, 6, 'COMBINATION', 'BENZEMA'),
(5, 6, 'COLLAR', 'BRAZIL'),
(6, 6, 'SLEEVE ENDS', 'WEBBING'),
(7, 6, 'SIDE PANTS STRIPE', 'BENZEMA'),
(8, 6, 'PANTS', 'AIRWALK');
...
(6, 'WO0408-001', 6, 'LEIF', 'KAOS', '-', 12, NULL, '2026-04-14', '-', 1, 'PROSES_PRODUKSI', '2026-04-08 06:52:34', '2026-04-08 06:52:34');
...
(17, 6, 1, 'EZRA', '01', 'L', '', NULL, NULL, NULL, '', NULL),
(18, 6, 2, 'LEIF', '02', 'XL', '', NULL, NULL, NULL, '', NULL),
(19, 6, 3, 'KEVIN', '07', 'M', '', NULL, NULL, NULL, '', NULL),
(20, 6, 4, 'SANJAYA', '11', 'L', '', NULL, NULL, NULL, '', NULL),
(21, 6, 5, 'GLEN', '23', 'S', '', NULL, NULL, NULL, '', NULL),
(22, 6, 6, 'DIAN', '45', 'M', '', NULL, NULL, NULL, '', NULL);
...
(25, 6, 1, 'TERSEDIA', NULL, NULL, NULL),
(26, 6, 2, 'BELUM', NULL, NULL, NULL),
(27, 6, 3, 'BELUM', NULL, NULL, NULL),
(28, 6, 4, 'BELUM', NULL, NULL, NULL),
(29, 6, 5, 'BELUM', NULL, NULL, NULL),
(30, 6, 6, 'BELUM', NULL, NULL, NULL),
(31, 6, 7, 'BELUM', NULL, NULL, NULL),
(32, 6, 8, 'BELUM', NULL, NULL, NULL),
(33, 6, 9, 'BELUM', NULL, NULL, NULL),
(34, 6, 10, 'BELUM', NULL, NULL, NULL),
(35, 6, 11, 'BELUM', NULL, NULL, NULL),
(36, 6, 12, 'BELUM', NULL, NULL, NULL);
...
(3, 6, 'PLAYER', 12, '2026-04-14', '/uploads/1775632268257-1neckd.jpeg', '/uploads/1775632275573-5orhsa.jpeg', 'Ayres', 'Ayress rubber', 'polos', 'PRINT', 'polos', 'polos', 'ARIAL', '-', '-', 'EZ', 'JPEG-RGB 3 PASS', '2026-04-08 07:11:38', '2026-04-08 07:11:38');
...
(34, 3, 'FRONT BODY', 'AUTHENTIC WOVEN', 0),
(35, 3, 'BACK BODY', 'BENZEMA', 0),
(36, 3, 'SLEEVE', 'AIRWALK', 0),
(37, 3, 'COMBINATION', 'BENZEMA', 0),
(38, 3, 'COLLAR', 'BRAZIL', 0),
(39, 3, 'SLEEVE ENDS', 'WEBBING', 0),
(40, 3, 'SIDE PANTS STRIPE', 'BENZEMA', 0),
(41, 3, 'PANTS', 'AIRWALK', 0);
...
--
-- Indexes for table `order_detail_bahan`
--
ALTER TABLE `order_detail_bahan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_odb_order` (`order_id`);
...
--
-- AUTO_INCREMENT for table `order_detail_bahan`
--
ALTER TABLE `order_detail_bahan`
...
--
-- Constraints for table `order_detail_bahan`
--
ALTER TABLE `order_detail_bahan`
  ADD CONSTRAINT `fk_odb_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE;
